...
- Quando le conseguenze del sistema di distribuzione sono state comunicate a chi di dovere e la questione ha avuto un'escaltion fino ai massimi vertici, il più facoltoso e generoso finanziatore dell'OMS gli ha stroncato le gambe proprio quando pianificavano di erigersi a governo medico globale in caso di un'altra pandemia. Giusto per dire che "imbecilli" non è un epiteto gettato verso l'alto frutto di una qualche frustrazione esistenziale ma piuttosto un elemento di certezza tale da aver falciato globalmente la reputazione dell'OMS al picco del suo massimo potere geo-politico.
